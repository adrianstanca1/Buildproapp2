...
const pgUrl = "postgres://postgres.zwxyoeqsbntsogvgwily:Cumparavinde1.@db.zwxyoeqsbntsogvgwily.supabase.co:5432/postgres";

async function harmonize() {
    console.log('🐘 Connecting to PostgreSQL (zwxyoeqsbntsogvgwily - DIRECT) for schema harmonization...');
    const pool = new Pool({
