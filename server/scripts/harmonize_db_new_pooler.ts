...
const pgUrl = "postgres://postgres.zwxyoeqsbntsogvgwily:Cumparavinde1.@aws-1-eu-west-2.pooler.supabase.com:6543/postgres?sslmode=require&pgbouncer=true";

async function harmonize() {
    console.log('🐘 Connecting to PostgreSQL (zwxyoeqsbntsogvgwily - POOLER) for schema harmonization...');
    const pool = new Pool({
