                                    ...
                                    {col.items.map((item, i) => {
                                        ...
                                        return (
                                            <div
                                                ...
                                                className={`bg-white p-4 rounded-xl border-y border-r border-l-[6px] shadow-sm hover:shadow-md transition-all cursor-pointer group relative flex flex-col gap-2 ${depStatus.isBlocked && item.status !== 'Done'
