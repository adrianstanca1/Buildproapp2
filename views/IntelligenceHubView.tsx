                        ...
                        <div className="bg-black/50 backdrop-blur-md border border-zinc-700 rounded-lg p-1 flex">
                            { ( [ 'SAFETY', 'QUALITY', 'PROGRESS' ] as AnalysisMode[] ).map( m => (
                                <button
                                    ...
                                    className={ `px-4 py-1.5 rounded-md text-xs font-bold transition-all ${ mode === m
            ...
            <div className="w-[400px] bg-zinc-900 border-l border-zinc-800 flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4 custom-scrollbar">
                    ...
                    { observations.map( ( obs ) => (
                        <div
                            key={ obs.id }
                            className={ `p-4 rounded-xl border relative group animate-in slide-in-from-right-4 fade-in duration-500 ${ obs.severity === 'CRITICAL' ? 'bg-red-950/30 border-red-500/50' :
                        ...
                        >
                            <div className="flex justify-between items-start mb-2">
                                <div className={ `text-[10px] font-bold px-2 py-0.5 rounded uppercase ${ obs.severity === 'CRITICAL' ? 'bg-red-500 text-white' :
