...
import { Plus, Search, Filter, FileText, Calendar, DollarSign, Paperclip, MoreVertical, Zap, CheckCircle2, AlertCircle, Clock } from 'lucide-react';
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <button className="flex items-center gap-2 px-4 py-2 bg-[#0f5c82] text-white rounded-xl font-bold hover:bg-[#0c4a6e] transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 active:translate-y-0">
