    ...
    <div className="flex flex-col h-full bg-white relative">
      ...
      <div className="h-16 border-b border-zinc-200 flex items-center px-6 bg-white sticky top-0 z-10 justify-between shadow-sm">
        <div className="flex items-center gap-3">
          <div className={ `w-8 h-8 rounded-lg flex items-center justify-center text-white shadow-sm transition-colors ${ mode === 'THINKING' ? 'bg-purple-600' : mode === 'SEARCH' ? 'bg-blue-600' : mode === 'MAPS' ? 'bg-green-600' : mode === 'LITE' ? 'bg-orange-500' : 'bg-[#0f5c82]'
            }` }>
