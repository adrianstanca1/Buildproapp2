...
const PAGE_ROLES: Record<string, UserRole[]> = {
  ...
  'WORKFORCE': [UserRole.SUPERADMIN, UserRole.COMPANY_ADMIN, UserRole.PROJECT_MANAGER, UserRole.HR],
  ...
  'CLIENTS': [UserRole.SUPERADMIN, UserRole.COMPANY_ADMIN, UserRole.PROJECT_MANAGER, UserRole.SALES],
